...
function _simple_first(d3,output,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1200;
...
function _simple_second(d3,output,drag,invalidation)
{
  const width = 1500;
  const height = 1200;
...
function _simple_third(d3,output,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1500;
  const height = 1200;
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple_first")).define("simple_first", ["d3","output","invalidation"], _simple_first);
  main.variable(observer("simple_second")).define("simple_second", ["d3","output","drag","invalidation"], _simple_second);
  main.variable(observer("simple_third")).define("simple_third", ["d3","output","drag","invalidation"], _simple_third);
